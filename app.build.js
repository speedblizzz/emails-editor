  ...
  _createClass(EmailsEditor, [{
    ...
    value: function createNewEmailInputElement() {
      ...
      newEmailInput.addEventListener('keyup', function (event) {
        var isSpaceBarEvent = event.keyCode === SPACEBAR_KEY_CODE;
        var isCommaEvent = event.key === ',';
