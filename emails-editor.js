...
module.exports = function (config) {
  return new _editorClass2.default(config);
};
...
function () {
  ...
  function EmailsEditor(container, options) {
    ...
    this.options = _objectSpread({}, options, {
      classes: _objectSpread({}, defaultClasses)
    });
    this.emails = [];
    this.callbacks = {};
    this.init();
